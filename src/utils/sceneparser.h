...
private:
    static void applyTransform(glm::mat4& ctm, SceneTransformation* newTransform);
    static void traverseTree(SceneNode* node, RenderData& renderData, glm::mat4* parentCTM);
};
